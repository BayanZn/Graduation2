...
Route::group(['prefix' => 'notifications', 'middleware' => 'auth'], function () {
    ...
    Route::delete('/{id}', action: [\App\Http\Controllers\NotificationController::class, 'destroy'])
...
Route::group(['prefix' => 'student', 'middleware' => ['auth', 'role.student']], function () {
    ...
    // Grades
    Route::get('/projects/{project}/grades', [StudentGradesController::class, 'show'])
        ->name('student.grades.show');
    Route::get('/projects/{project}/grades/export', [StudentGradesController::class, 'exportPdf'])
        ->name('student.grades.export');
});
...
Route::group(['prefix' => 'supervisor', 'middleware' => ['auth', 'role.supervisor']], function () {
    ...
    Route::post('/defenses/{defense}/grade', [SupervisorDefensesController::class, 'submitGrade'])
        ->name('supervisor.defenses.submit-grade');
