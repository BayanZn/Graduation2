...
const form = useForm({
    ...
    description: '',
    project_type: '',
    specialization_id: props.user_specialization_id,
    department_id: null,
});
...
// Store project
const store = () => {
    form.post(route('supervisor.projects.store'), {
        preserveScroll: true,
        onSuccess: () => {
            let { Toast } = useAlert();
...
<template>
    <Head title="Propose New Project" />
    ...
    <Breadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Propose New</li>
    </Breadcrumb>
    <!-- Breadcrumb End -->
