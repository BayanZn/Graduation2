...
const filteredSpecializations = computed(() => {
    ...
    return props.specializations.filter((s) => s.department_id === form.department_id);
});

// Reset specialization when department changes, but only if it's not the initial load
watch(
    () => form.department_id,
    (newVal, oldVal) => {
...
<template>
    ...
    <Breadcrumb>
        ...
        <li class="breadcrumb-item fw-bold">
            <Link :href="route('projects.index')" class="fw-bold text-secondary">Projects</Link>
        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <v-select
                                        v-model="form.status"
                                        :options="['Proposed', 'Approved', 'Rejected', 'Completed']"
