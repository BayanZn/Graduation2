...
let params = reactive({
    ...
    project_type: props.filters.project_type ?? null,
});
...
const filteredSpecializations = computed(() => {
    ...
    return props.specializations.filter((s) => s.department_id === params.department_id);
});
...
watch(
    params,
    debounce(() => {
        router.get(route('projects.declined'), pickBy(params), {
            preserveScroll: true,
            preserveState: true,
        });
    }, 300),
...
<template>
    ...
    <Breadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Declined Projects</li>
    </Breadcrumb>
    <!-- Breadcrumb End -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 mb-3 mb-md-0">
                            ...
                            <button @click="toggleFilters" class="btn btn-outline-secondary ms-2">
