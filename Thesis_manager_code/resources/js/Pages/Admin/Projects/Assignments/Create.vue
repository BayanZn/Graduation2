...
const filteredSupervisors = computed(() => {
    if (!form.project_id || !selectedProject.value) {
        return props.supervisors;
    }
    return props.supervisors.filter((s) => s.specialization_id === selectedProject.value.specialization_id);
});
...
const filteredStudents = computed(() => {
    ...
    return props.students.filter((s) => s.specialization_id === selectedProject.value.specialization_id);
});

const userLabel = (user) => {
    const short = user.specialization?.short_name;
    return short ? `${user.name} (${short})` : user.name;
};
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    >
                                        <template #option="{ name, email, specialization }">
                                            <div>
                                                <strong>
                                                    {{ name }}
                                                    <span v-if="specialization" class="text-primary">
