...
class DepartmentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'short_name.unique' => 'The short name is already in use. Please choose another one.',
            'name.required' => 'The department name field is required.',
            'name.unique' => 'The department name is already in use. Please choose another one.',
        ]);
