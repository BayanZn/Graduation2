...
<template>
    ...
    <Breadcrumb>
        ...
        <li class="breadcrumb-item">
            <Link :href="route('student.assigned-projects.index')">My Assigned Projects</Link>
        </li>
            ...
            <div class="card border-0 shadow">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2 align-items-center flex-wrap">
                        <Link :href="route('student.project-submissions.index')" class="btn btn-sm btn-success">
                            <i class="ri-file-upload-line me-1"></i>Submit Chapters
                        </Link>
